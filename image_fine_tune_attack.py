...
def arg_parse():
    ...
    parser.add_argument('--attack_method', type=str, default='ILAF, ENS_FT_I2V', help='')
...
if __name__ == '__main__':
    ...
    attack_method = getattr(image_attacks, args.attack_method)() # model_name_lists, depth=2, steps=100
